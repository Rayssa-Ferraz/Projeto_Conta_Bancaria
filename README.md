...
1. Clone o repositório do Projeto [Conta Bancária](https://github.com/Rayssa-Ferraz/Projeto_Conta_Bancaria) dentro da pasta do *Workspace* do Eclipse/STS

```bash
git clone https://github.com/Rayssa-Ferraz/Projeto_Conta_Bancaria
```
